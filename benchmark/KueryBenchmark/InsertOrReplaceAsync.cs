...
{
    public class InsertOrReplaceAsync : BenchmarkBase
    {
        ...
        public Task<int> SQLiteNetPCL() =>
            SQLiteNetPclAsyncConnection.InsertOrReplaceAsync(_sqlitePclNetTodo);

        [BenchmarkDotNet.Attributes.Benchmark]
        public Task<int> Kuery() =>
            KueryConnection.InsertOrReplaceAsync(_kueryTodo);
    }
}
