...
{
    public class ByteArrayTest : IClassFixture<SqlClientFixture>
    {
        readonly SqlClientFixture fixture;

        public ByteArrayTest(SqlClientFixture fixture)
        {
            ...
            using (var cmd = connection.CreateCommand())
            {
                cmd.CommandText = $@"
                    create table [{nameof(ByteArrayClass)}] (
                        {nameof(ByteArrayClass.ID)} integer primary key identity,
