...
{
    public class IgnoreTest : IClassFixture<NpgsqlFixture>
    {
        readonly NpgsqlFixture fixture;

        public IgnoreTest(NpgsqlFixture fixture)
        {
        ...
        void CreateIgnoreTestObjTable(global::Npgsql.NpgsqlConnection connection)
        {
            ...
            using (var cmd = connection.CreateCommand())
            {
                cmd.CommandText = $@"
                    create table ""{nameof(IgnoreTestObj)}"" (
                        ""{nameof(IgnoreTestObj.Id)}"" integer primary key generated by default as identity,
                        ""{nameof(IgnoreTestObj.Text)}"" varchar(50) null
                    );";
                cmd.ExecuteNonQuery();
            }
        }
        ...
        void CreateIgnoreInheritTableClassTable(global::Npgsql.NpgsqlConnection connection)
        {
            ...
            using (var cmd = connection.CreateCommand())
            {
                cmd.CommandText = $@"
                    create table ""{nameof(IgnoreInheritTableClass)}"" (
                        ""{nameof(IgnoreInheritTableClass.Name)}"" varchar(50) null
                    );";
                cmd.ExecuteNonQuery();
            }
        }
        ...
        void CreateRedefinedClassTable(global::Npgsql.NpgsqlConnection connection)
        {
            ...
            using (var cmd = connection.CreateCommand())
            {
                cmd.CommandText = $@"
                    create table ""{nameof(RedefinedClass)}"" (
                        ""{nameof(RedefinedClass.Name)}"" varchar(50) null,
                        ""{nameof(RedefinedClass.Value)}"" varchar(50) null
                    );";
                cmd.ExecuteNonQuery();
            }
        }
