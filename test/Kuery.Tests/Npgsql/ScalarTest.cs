...
{
    public class ScalarTest : IClassFixture<NpgsqlFixture>
    {
        readonly NpgsqlFixture fixture;

        public ScalarTest(NpgsqlFixture fixture)
        {
            ...
            using (var cmd = connection.CreateCommand())
            {
                cmd.CommandText = $@"
                    create table ""{nameof(ScalarTestTable)}"" (
                        ""{nameof(ScalarTestTable.Id)}"" integer primary key generated by default as identity,
