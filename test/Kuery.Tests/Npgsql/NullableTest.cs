...
{
    public class NullableTest : IClassFixture<NpgsqlFixture>
    {
        readonly NpgsqlFixture fixture;

        public NullableTest(NpgsqlFixture fixture)
        {
            ...
            using (var cmd = connection.CreateCommand())
            {
                cmd.CommandText = $@"
                    create table ""{nameof(NullableIntClass)}"" (
                        ""{nameof(NullableIntClass.ID)}"" integer primary key generated by default as identity,
            ...
            using (var cmd = connection.CreateCommand())
            {
                cmd.CommandText = $@"
                    create table ""{nameof(NullableFloatClass)}"" (
                        ""{nameof(NullableFloatClass.ID)}"" integer primary key generated by default as identity,
                        ""{nameof(NullableFloatClass.NullableFloat)}"" real null
                    );";
                cmd.ExecuteNonQuery();
            }
        }
            ...
            using (var cmd = connection.CreateCommand())
            {
                cmd.CommandText = $@"
                    create table ""{nameof(StringClass)}"" (
                        ""{nameof(StringClass.ID)}"" integer primary key generated by default as identity,
                        ""{nameof(StringClass.StringData)}"" varchar(250) null
                    );";
                cmd.ExecuteNonQuery();
            }
        }
            ...
            using (var cmd = connection.CreateCommand())
            {
                cmd.CommandText = $@"
                    create table ""{nameof(NullableEnumClass)}"" (
                        ""{nameof(NullableEnumClass.ID)}"" integer primary key generated by default as identity,
                        ""{nameof(NullableEnumClass.NullableIntEnum)}"" integer null,
                        ""{nameof(NullableEnumClass.NullableTextEnum)}"" varchar(250) null
                    );";
                cmd.ExecuteNonQuery();
            }
        }
